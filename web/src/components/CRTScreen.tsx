 ...
 * shows a phosphor boot message instead of an empty box, which is honest about
 * the missing data and still looks like hardware.
 */
  ...
  return (
    <div className="bevel border-2 border-[var(--border)] bg-[var(--secondary)] p-2">
      <div className="crt aspect-[4/3] w-full">
        {coverURL ? (
          <img src={coverURL} alt={`${title} cover art`} loading="lazy" />
        ) : (
